...
[fully embedded within your own application](/docs/embedded-flow).
...
[_embedded_ the Kombo Connect flow](/docs/embedded-flow) into your own app. This
...
- **[Manual setup](/docs/manual-setup)** is perfect when you _already have_ the
  relevant credentials from your customer and just want to add the integration
  to Kombo.
- **[Magic links](/docs/magic-links)** are similar in that they also don't
  require any code, but they still allow your customers to go through the flow
  and enter the credentials themselves.
