...
- **[Manual setup](/manual-setup)** is perfect when you _already have_ the
  relevant credentials from your customer and just want to add the integration
  to Kombo.
- **[Magic links](/magic-links)** are similar in that they also don't require
  any code, but they still allow your customers to go through the flow and enter
