...
When you're just getting started with Kombo, you might not want to invest the time into building a proper integration with [Kombo Connect](/docs/connect) yet. Because of that, we allow you to _manually_ set up integrations through the Kombo Dashboard.
...
After clicking "Continue," you'll then be presented with the regular [Kombo Connect](/docs/connect) flow, except that in this case, it's _you_ going through it and not your customer:

![1376](/images/7a6d096-Connection_flow.png "Connection flow.png")![1376](/images/7a6d096-Connection_flow.png "Click to close...") 

After going through the flow, the integration will be set up, and you can start using our unified API. To learn more about that, check out [our general Getting Started guide](/docs/getting-started).